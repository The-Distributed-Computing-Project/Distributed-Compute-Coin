...
public class clnt
{
	...
	public static void Main()
	{
		...
		StreamReader readConfig = new StreamReader("D:\\Code\\DC-Cryptocurrency\\BlockchainClient\\config.txt");
	...
	static void WaitForConfirmation()
	{
		...
		try
		{
			...
			tcpclnt.Close();
			StreamWriter writeBlock = new StreamWriter("D:\\Code\\DC-Cryptocurrency\\BlockchainClient\\config.txt");
			writeBlock.Write(" \n ");
			writeBlock.Close();
		}
		catch (Exception e)
	...
	static void Sync(int whichBlock)
	{
		try
		{
			...
			StreamWriter writeBlock = new StreamWriter("D:\\Code\\DC-Cryptocurrency\\BlockchainClient\\blockchain\\block" + whichBlock + ".txt");
