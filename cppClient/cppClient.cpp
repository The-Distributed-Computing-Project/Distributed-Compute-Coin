...
int main()
{
    ...
    fstream readConfig;
    readConfig.open("D:\\Code\\DC-Cryptocurrency\\CPPClient\\config.txt");
...
void WaitForConfirmation()
{
    ...
    try
    {
        ...
        closesocket(ConnectSocket);
        fstream writeBlock;
        writeBlock.open("D:\\Code\\DC-Cryptocurrency\\CPPClient\\config.txt", std::ios_base::app);
        writeBlock << (" \n ");
        writeBlock.close();
    }
...
static void Sync(int whichBlock)
{
    ...
    try
    {
        ...
        fstream writeBlock;
        writeBlock.open("D:\\Code\\DC-Cryptocurrency\\CPPClient\\blockchain\\block" + to_string(whichBlock) + ".txt", std::ios_base::app);
        writeBlock << (s);
        writeBlock.close();
    }
    catch (const std::exception&)
