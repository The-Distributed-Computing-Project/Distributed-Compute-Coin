...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "ee7f91f5566b6279aadf6d0b1aaf56b11963f527"
  WORKING_DIRECTORY "/home/sam/Code/Distributed-Compute-Coin/dcc_client/out-linux/_deps/cpr-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/sam/Code/Distributed-Compute-Coin/dcc_client/out-linux/_deps/cpr-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/sam/Code/Distributed-Compute-Coin/dcc_client/out-linux/_deps/cpr-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
